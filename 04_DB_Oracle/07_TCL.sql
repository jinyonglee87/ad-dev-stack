    ...
    TRANSCATION(트랜잭션)
     - 하나의 논리적인 작업 단위
       ...
       예시) ATM기기
            ...
            5. 현금 인출
            6. 완료
        - 각각의 업무들을 묶어서 하나의 작업 단위로 만드는 것을 트랜잭션이라 한다
    
    COMMIT : 모든 작업들을 정상적으로 처리하겠다고 확정
    ROLLBACK : 모든 작업들을 취소하겠다고 확정 (최종 COMMIT)
    SAVEPOINT : 임시 저장 시점을 정하고 ROLLBACK 진행시 SAVEPOINT까지 일부 롤백
*/
