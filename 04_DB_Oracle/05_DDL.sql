/*
    DDL(Data Definition Language) : 데이터 정의어
     ...
     - 객체 (schema)를 만들고(CREATE), 변경(ALTER)하고, 삭제(DROP)하는 언어 
    오라클에서 객체(구조) / Schema : 
        1. TABLE
        2. VIEW
        3. SEQUENCE
...
/*
    데이터 딕셔너리
     ...
     - 사용자가 객체를 생성하거나 객체를 변경하는 등의 작업을 할때
     데이터베이스 서버에 의해서 자동으로 갱신되는 테이블
*/
-- USER_TABLES : 사용자가 가지고 있는 테이블들의 전반적인 구조를
--               확인할 수 있는 시스템 테이블
SELECT * FROM USER_TABLES;

-- USER_TAB_COLUMNS : 사용자가 가지고 있는 테이블들 상의 모든 컬럼의 
--                전반적이 구조를 확인할 수 있는 시스템 테이블
...
/*
    ...
    COMMENT ON COLUMN TABLE_NAME.COLUMN_NAME is '주석내용';
*/
...
/*
    제약조건(CONSTRAINTS)
     ...
     - 종류 : NOT NULL, UNQIUE, CHECK, PRIMARY KEY, FOREIGN KEY
    
    CREATE TABLE 테이블명 (
    컬럼명 자료형(크기)) [CONSTRAINT] 제약조건,
    컬럼명 자료형(크기)) [CONSTRAINT] 제약조건
*/
/*
    NOT NYLL 제약조건
...
INSERT INTO MEM_NOTNULL (MEM_NO, MEM_ID, MEM_PW, MEM_NAME, MEM_DATE) VALUES(2, 'user02', 'pass02', '이진용', SYSDATE);
...
INSERT INTO MEM_UNIQUE (MEM_NO, MEM_ID, MEM_PW, MEM_NAME, MEM_DATE)
VALUES(2, 'user02', 'pass02', '이진용', SYSDATE);
INSERT INTO MEM_UNIQUE VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO MEM_UNIQUE(MEM_NO, MEM_ID, MEM_PW, MEM_NAME, GENDER, MEM_DATE)
VALUES(3, 'user03', 'pass03', '곽병현', 'ㅇ', SYSDATE);
SELECT * FROM MEM_UNIQUE;

/*
    CHECK(조건식) 제약조건
     - 해당 컬럼에 들어올 수 있는 값에 대한 조건을 제시해볼 수 있다
...
INSERT INTO MEM_CHECK (MEM_NO, MEM_ID, MEM_PW, MEM_NAME, MEM_DATE, GENDER)
VALUES(2, 'user02', 'pass02', '이진용', SYSDATE, '남');
INSERT INTO MEM_CHECK VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO MEM_CHECK(MEM_NO, MEM_ID, MEM_PW, MEM_NAME, GENDER, MEM_DATE, EMAIL)
VALUES(3, 'user03', 'pass03', '곽병현', '남', SYSDATE, 'bbb@sss.com');
...
*/
DROP TABLE MEM_PRI;
DROP SEQUENCE MEM_SEQ; -- SEQUENCE 삭제
...
INSERT INTO MEM_PRI (MEM_NO, MEM_ID, MEM_PW, MEM_NAME, MEM_DATE, GENDER)
VALUES(MEM_SEQ.NEXTVAL, 'user02', 'pass02', '이진용', SYSDATE, '남');
INSERT INTO MEM_PRI VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO MEM_PRI(MEM_NO, MEM_ID, MEM_PW, MEM_NAME, GENDER, MEM_DATE, EMAIL)
VALUES(MEM_SEQ.NEXTVAL, 'user03', 'pass03', '곽병현', '남', SYSDATE, 'bbb@sss.com');
SELECT * FROM MEM_PRI;
...
INSERT INTO MEM_PRI2 (MEM_ID, MEM_PW, MEM_NAME, MEM_DATE, GENDER, PHONE, EMAIL, MEM_DATE)
VALUES('user01', 'pass01', '윤의진', SYSDATE, '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
INSERT INTO MEM_PRI2 (MEM_ID, MEM_PW, MEM_NAME, MEM_DATE, GENDER, PHONE, EMAIL, MEM_DATE)
VALUES('user02', 'pass02', '이진용', SYSDATE, '남');
INSERT INTO MEM_PRI2 VALUES (NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO MEM_PRI2 (MEM_ID, MEM_PW, MEM_NAME, MEM_DATE, GENDER, PHONE, EMAIL, MEM_DATE)
VALUES('user03', 'pass03', '곽병현', '남', SYSDATE, 'bbb@sss.com');
...
INSERT INTO MEM_MEMBER (MEM_ID, MEM_PW, MEM_NAME, GRADE_ID)
...
CREATE TABLE MEM_MEMBER2(
    ...
    MEM_PW VARCHAR2(20) NOT NULL,
    MEM_NAME VARCHAR2(20) NOT NULL,
    GRADE_ID NUMBER REFERENCES MEM_GRADE(GRADE_CODE) -- FOREIGN KEY
);

INSERT INTO MEM_MEMBER2 (MEM_ID, MEM_PW, MEM_NAME, GRADE_ID)
VALUES('user01', 'pass01', '윤의진', 1);
INSERT INTO MEM_MEMBER2 (MEM_ID, MEM_PW, MEM_NAME, GRADE_ID)
VALUES('user02', 'pass02', '이진용', 2);
INSERT INTO MEM_MEMBER2 (MEM_ID, MEM_PW, MEM_NAME, GRADE_ID)
...
/*
    자식테이블 생성시 외래키 제약조건 부여할 떄 삭제옵션 지정
     * 삭제옵션 : 부모테이블의 데이터 삭제 시 그 데이터를
                 사용하고 있는 자식테이블의 값을 어떻게 처리할 건지
...
/*
    DEFAULT 기본값
     - 제약조건 아님!
     - 컬럼을 선정하지 않고 INSERT 시 NULL이 아닌
     - 기본값을 INSERT 하고자 할 떄 세팅해둘 수 있는 값
*/
...
INSERT INTO MEMBER(MEM_NAME, MEM_AGE, HOBBY) VALUES('곽병현', 15, '영화 감상');
...
-- PUB_NO - 숫자, 외래키(PUBLISHER의 PUB_NO, 삭제 조건 CASE)
CREATE TABLE BOOK(
...
-- 테이블명 : MEMBER (*테이블 삭제 후 재생성)
-- 컬럼 : MEMBER_NO - 숫자, 기본키
--       MEMBER_ID - 문자(50), 중복 허용 X (UNIQUE)
CREATE TABLE MEMBER(
